...
public class GameManager : MonoBehaviour
{
    ...
    /// </summary>
    private List<DifficultyLevel> _internalDifficultyLevels;
    ...
    /// </summary>
    public PastaManager pastaManager;
    ...
    void Awake()
    {
        ...
        _internalDifficultyLevels = new List<DifficultyLevel>();
        foreach (DifficultyLevel dl in difficultyLevels)
        {
            _internalDifficultyLevels.Add(dl);
        }
        _internalDifficultyLevels.Sort(new SortDifficultyLevelDescending());
